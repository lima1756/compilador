...
namespace compiler
{
    class Program
    {
        ...
        {
            string savePath = new FileInfo(path).Directory.FullName;
            string fileName = Path.GetFileNameWithoutExtension(new FileInfo(path).FullName);
            string value;
            fileName = fileName + ".cpp";
            string fullPath = savePath + "\\" + fileName;
            Console.WriteLine("Archivo: " + fullPath);
            FileStream fs = File.Create(fullPath);
            fs.Close();
            StreamWriter file = new StreamWriter(fullPath, true);
            file.Write("#include \"stdafx.h\"\r\n");
            for (int z = 1; myTokens.Count > 0; z++)
            {
                value = myTokens.First.Value.myValue;
                if (myTokens.First.Value.id == "string")
                {
                ...
                else if (myTokens.First.Value.id == "read")
                {
                    file.Write("scanf");
                }
                else if (myTokens.First.Value.id == "write")
                {
                    file.Write("printf");
                }
                else if (myTokens.First.Value.id == "if")
                {
                    file.Write("if");
                }
                else if (myTokens.First.Value.id == "else")
                {
                    file.Write("else");
                }
                else if (myTokens.First.Value.id == "while")
                {
                    file.Write("while");
                }
                else if (myTokens.First.Value.id == "do")
                {
                    file.Write("do");
                }
                else if (myTokens.First.Value.id == "for")
                {
                    file.Write("for");
                }
                else if (myTokens.First.Value.id == "integer")
                {
                    file.Write("int ");
                }
                else if (myTokens.First.Value.id == "float")
                ...
                else if (myTokens.First.Value.id == "return")
                {
                    file.Write("return ");
                }
                else if (myTokens.First.Value.id == "UserDefined")
                ...
                else if (myTokens.First.Value.id == "Entero")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "Flotante")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "OpAdd")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "OpMinus")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "OpMul")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "OpDiv")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "LeftPar")
                ...
                else if (myTokens.First.Value.id == "RightPar")
                {
                    file.Write("}");
                    file.Write("\r\n");
                }
                else if (myTokens.First.Value.id == "LeftBrack")
                {
                    file.Write("(");
                }
                else if (myTokens.First.Value.id == "RightBrack")
                ...
                else if (myTokens.First.Value.id == "OpAnd")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "Direction")
                {
                    file.Write("&");
                }
                else if (myTokens.First.Value.id == "OpOr")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "OpNotEqu")
                {
                    file.Write(value);
                }

                else if (myTokens.First.Value.id == "OpEqu")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "OpGtEq")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "OpLtEq")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "OpAssign")
                {
                    file.Write("=");
                    translateOp(fullPath, file);
                }
                else if (myTokens.First.Value.id == "OpNot")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "OpLt")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "OpGt")
                {
                    file.Write(value);
                }
                else if (myTokens.First.Value.id == "EOL")
                {
                    file.Write(";");
                    file.Write("\r\n");
                }
            ...
            file.Close();
            Console.WriteLine("¿Desea abrir el archivo? Presione la tecla S en caso que si.");
        ...
        {
            for (int x = 1; x < myTokens.Count; x++)
            {
                string value = myTokens.First.Value.myValue;
                if (myTokens.First.Value.id == "string")
                {
                    value = value.Remove(0, 1);
                    value = value.Remove(value.Length - 1, 1);
